                            ...
                            foreach( $property_images as $image_id => $url ) {
                                ...
                                echo '<div class="col-sm-2">';
                                    echo '<div class="gallery-thumbnail">';
                                        ...
                                        echo '<a class="icon icon-delete" data-toggle="tooltip" title="'.__('Delete this image', 'opalestate').'" data-property-id="'.intval($post_id).'" data-attachment-id="'.intval($image_id).'" href="javascript:;">';
