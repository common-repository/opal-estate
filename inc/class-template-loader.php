...
class Opalestate_Template_Loader {
	...
	public static function templates( $template ) {
		...
		$custom_post_types = array( 'opalestate_property', 'opalestate_agent', 'opalestate_office' );
		...
		if( is_post_type_archive( 'opalestate_office' ) ){
			return self::locate( 'archive-opalestate_office'  );
		}
