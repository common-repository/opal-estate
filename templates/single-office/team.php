<?php 
	$team = get_post_meta( get_the_ID(), OPALESTATE_OFFICE_PREFIX . 'team', true ); 
	...
	<?php if( $team): ?> 
		<div class="row">
			...
			<div class="col-lg-<?php echo esc_attr($colclass); ?> col-md-<?php echo esc_attr($colclass); ?> col-sm-<?php echo esc_attr($colclass); ?>">
            	<?php echo Opalestate_Template_Loader::get_template_part( 'content-user-grid', array( 'user_id' => $user_id) ); ?>
        	</div>
			<?php  endforeach; ?>
		</div>
